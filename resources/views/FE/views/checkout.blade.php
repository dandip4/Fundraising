    ...
    <section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#FCF7F1] overflow-x-hidden">
        <div class="header flex flex-col overflow-hidden h-[220px] relative">
            <nav class="pt-5 px-3 flex justify-between items-center relative z-20">
                <div class="flex items-center gap-[10px]">
                    <a href="{{route('fe.support', $fundraising->slug)}}" class="w-10 h-10 flex shrink-0">
        ...
        <div class="flex flex-col z-30">
            <div id="content"
                ...
                <form method="POST" action="{{route('fe.store', ['fundraising' => $fundraising->slug, 'totalAmountDonation' => $totalAmountDonation])}}" class="flex flex-col gap-5" enctype="multipart/form-data">
                    @csrf
